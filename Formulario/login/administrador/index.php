...
?>
  ...
  <head>
    ...
    <link rel="stylesheet" href="../../bootstrap-4.5.3-dist/js/bootstrap.bundle.min.js">
  ...
  <body style="background-color: #154c79; color: white; background-image: url(../../fondo3.png);">
    ...
    <div class="text-center" style="margin: 2em">
      <h1>Página principal del administrador: "<?php echo $_SESSION['Usuario_nombre'] ?> <?php echo $_SESSION["Usuario_apellido1"] ?> <?php echo $_SESSION["Usuario_apellido2"] ?>"</h1>
    ...
    <div class="text-center" style="border: 2px solid white; box-shadow: 0 0 40px 0 white, 0 0 5px 0 white;padding: 2em; color: black; background-color: #610027; border-radius: 30px; max-width: 500px; margin: auto">
      ...
      ?>
        <div class="fakeimg" style="background-color: #352f4f; margin-top: 3em;"><img style="border: 2px solid white" class="fakeimg" src="../modificarPerfil/imagenes/<?php echo $_SESSION['Usuario_fotografia'] ?>" /></div>
      <?php
      } else {
      ?>
